...
export default function Projects() {
  ...
  const otherProjects = projectsData.filter((project) => !project.featured).slice(0, 3)
  ...
  return (
    <section id="projects-section" className="py-16 relative">
      <div className="absolute -left-10 bottom-20 -rotate-12 opacity-30 z-0">
        <Image src="/images/penguins.png" alt="Decorative illustration" width={300} height={300} />
      </div>
      ...
      >
        ...
        <p className="text-gray-700 max-w-2xl">
          Here are some of my favorite projects. Each one represents a unique challenge and learning experience.
        </p>
      </motion.div>

      <div className="mb-16">
        <h3 className="text-xl font-semibold mb-6 handwritten sticky-note inline-block px-4 py-2">Featured Projects</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-6 handwritten sticky-note inline-block px-4 py-2">Other Projects</h3>
